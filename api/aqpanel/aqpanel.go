...
func (c *APIClient) GetNodeRule() (*[]api.DetectRule, error) {
	...
	// aqpanel only support the rule for v2ray
...
func (c *APIClient) ReportNodeStatus(nodeStatus *api.NodeStatus) (err error) {
	...
	*/
	return nil //aqpanel not Support ReportNodeStatus
}
...
func (c *APIClient) ReportNodeOnlineUsers(onlineUserList *[]api.OnlineUser) error {
	...
	*/
	return nil // aqpanel not Support ReportNodeOnlineUsers
}
...
func (c *APIClient) ReportIllegal(detectResultList *[]api.DetectResult) error {
	...
	*/
	return nil // aqpanel not Support ReportIllegal
}
...
func (c *APIClient) ParseV2rayNodeResponse(nodeInfoResponse *simplejson.Json) (*api.NodeInfo, error) {
	...
	if tmpInboundInfo, ok := nodeInfoResponse.CheckGet("inbound"); ok {
		...
		// Compatible with aqpanel 1.16.4
