...
func (c *APIClient) GetNodeInfo() (nodeInfo *api.NodeInfo, err error) {
	...
	if !disableCustomConfig {
		...
		if err != nil {
			...
			return nil, fmt.Errorf("Parse node info failed: %s, \nError: %s, \nPlease check the doc of custom_config for help: https://AikoCute-Offical.github.io/AikoR-doc/dui-jie-sspanel/sspanel/sspanel_custom_config", string(res), err)
		}
	} else {
		switch c.NodeType {
		case "V2ray":
