...
[![](https://img.shields.io/github/downloads/AikoR-Project/AikoR/total.svg?style=flat-square)](https://github.com/AikoR-Project/AikoR/releases)
[![](https://img.shields.io/github/v/release/AikoR-Project/AikoR?style=flat-square)](https://github.com/AikoR-Project/AikoR/releases)
...
```
wget --no-check-certificate -O AikoR.sh https://raw.githubusercontent.com/AikoR-Project/AikoR-Install/master/AikoR.sh && bash AikoR.sh
```
...
```
docker pull ghcr.io/AikoR-Project/aikor:latest && docker run --restart=always --name aikor -d -v ${PATCH_TO_CONFIG}/aiko.yml:/etc/AikoR/aiko.yml --network=host ghcr.io/AikoR-Project/aikor:latest
```
...
[![Stargazers over time](https://starchart.cc/AikoR-Project/AikoR.svg)](https://starchart.cc/AikoR-Project/AikoR)
